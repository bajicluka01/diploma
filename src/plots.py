...
plt.figure(4)
plt.plot(x, list(zip(forwardLCS, backwardLCS, fbLCS, diagonalLCSmemory, diagonalLCSmemoryParallel)), label=['naprej', 'nazaj', 'naprej-nazaj', 'diagonalno', 'diagonalno paralelno (6 niti)'])
...
plt.figure(5)
plt.plot(x2, list(zip(forwardLCSspace, backwardLCSspace, fbLCSspace, diagonalLCSspace, diagonalLCSspaceParallel)), label=['naprej', 'nazaj', 'naprej nazaj', 'diagonalno', 'diagonalno paralelno (6 niti)'])
...
plt.figure(6)
plt.plot(x4, list(zip(fbLCSspaceExtended, diagonalLCSspaceParallelExtended)), label=['naprej nazaj', 'diagonalno paralelno (6 niti)'])
plt.title('Primerjava algoritmov za računanje LCS s prostorsko optimizacijo')
plt.xlabel('dolžina niza')
plt.ylabel('čas izvajanja (sekunde)')
plt.legend()
